...
function start_timer(timer) {
  ...
  if (minutes.innerHTML === '00' && seconds.innerHTML === '00') {
      ...
      [minutes.innerHTML, seconds.innerHTML]  = format_time(minutes.innerHTML, seconds.innerHTML, at_start);
...
function format_time(minutes, seconds, at_start) {

  let now = performance.now();
  let milliseconds = now - at_start;
  console.log(now, at_start);

  let seconds_left = Math.ceil((25 * 60) - milliseconds / 1000);
